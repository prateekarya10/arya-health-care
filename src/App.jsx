...
const PatientsList = React.lazy(() =>
	import("./pages/patients/pages/PatientsList")
);
const AddPatient = React.lazy(() =>
	import("./pages/patients/pages/AddPatient")
);
const UpdatePatient = React.lazy(() =>
	import("./pages/patients/pages/UpdatePatient")
);
const PatientDetail = React.lazy(() =>
	import("./pages/patients/pages/PatientDetail")
);
